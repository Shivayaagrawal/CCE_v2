import { DecisionRecord, Layer, TelemetryRow, Check } from '../types';

const SHARED_TELEMETRY_35: TelemetryRow[] = [
...
const UC4_TELEMETRY_6: TelemetryRow[] = [
...
export const UC1_RECORD: DecisionRecord = {
  ...
  layers: {
    input: { key: 'input', index: 1, name: 'Input Assurance', purpose: 'Verifies structural integrity, bounds, and electrical validity of all ingested telemetry vectors.', result: 'clear', summary: '10 of 10 Checks Passed', checks: [], finding: null },
    model: { key: 'model', index: 2, name: 'Model Assurance', purpose: 'Verifies model identity, production version alignment, and inference plausibility.', result: 'clear', summary: '4 of 4 Checks Passed', checks: [], finding: null },
    policy: { key: 'policy', index: 3, name: 'Policy Assurance', purpose: 'Evaluates statutory limits (AIS-156, AIS-038) and commercial battery replacement thresholds.', result: 'clear', summary: '5 of 5 Checks Passed', checks: [], finding: null },
  ...
  suppliedModelCard: { entries: [{ label: 'Architecture', value: 'Deep Learning Neural Network' }], provenanceNote: 'Supplied by the source system. Not measured or verified by CCE.' },
...
export const UC2_RECORD: DecisionRecord = {
  ...
  layers: {
    ...UC1_RECORD.layers,
    model: { ...UC1_RECORD.layers.model, result: 'limitation', summary: 'Incoming DLL V1 does not match configured DLL V2.', finding: 'Incoming model version DLL:V1 does not match configured DLL:V2' },
...
export const UC3_RECORD: DecisionRecord = {
  ...
  layers: {
    ...UC1_RECORD.layers,
    policy: { ...UC1_RECORD.layers.policy, result: 'breach', summary: 'Cell imbalance 64.97 mV exceeds the 50 mV policy threshold.', finding: 'Cell imbalance 64.97 mV exceeds statutory 50 mV ceiling' },
...
export const UC4_RECORD: DecisionRecord = {
  ...
  layers: {
    ...UC1_RECORD.layers,
    policy: { ...UC1_RECORD.layers.policy, result: 'breach', summary: '76.2% is below the 80% replacement-review threshold.', finding: 'SoH 76.2% triggers replacement review (<80.0%)' },
